...
const { updateImageName,uploadProfileImage,multerFile,getProfileImageUrl,PUProfileRegisterInMarriageProfileTable,
...
// router.route('/PUProfileRegisterInMarriageProfileTable').post(protect,PUProfileRegisterInMarriageProfileTable)
